...
var Input = digicore.Transaction.Input;
var Output = digicore.Transaction.Output;
var PrivateKey = digicore.PrivateKey;
var Script = digicore.Script;
var Address = digicore.Address;
var Networks = digicore.Networks;
var Opcode = digicore.Opcode;
var errors = digicore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(digicore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(digicore.Script);
